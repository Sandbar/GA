...
def modify_pt(pt=None, delt_name=None, creative_medias=None, country=None, platform=None, roas_average_floor=1500):
    ...
    # 5、设置roas
    pt['adset_spec']['bid_constraints'] = {'roas_average_floor': roas_average_floor}    
